...
public class ListaEventosDisponibles extends AppCompatActivity {
    private ListView lv_eventos;
    private SwipeRefreshLayout swipeActualizarLista;
    private TextView txt_nombreCompletoUsuarioLogueado;
    int ACTUALIZARLISTA = 0;
    private AdapterListaEventos adapter;
    private RequestQueue request;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lista_eventos_disponibles);

        txt_nombreCompletoUsuarioLogueado = (TextView)findViewById(R.id.txt_nombreCompletoUsuarioLogueado);
        lv_eventos = (ListView) findViewById(R.id.lv_eventos);
        swipeActualizarLista = (SwipeRefreshLayout) findViewById(R.id.swipeActualizarLista);

        adapter = new AdapterListaEventos(this);
    ...
    private void getListaEventos(){
        ...
        String url = MiAplicacion.URL_SERVICE + "datos.php";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>()
        {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i = 0; i < jsonArray.length(); i++){
                        ...
                        Evento.listaEventos.add(new Evento(
                                jsonData.getString("IDFORMATOTICKET").trim(),
                                jsonData.getString("DESCRIPCION"),
                                jsonData.getString("FECHAREGISTRO"),
                                jsonData.getString("OBSERVACION")
                        ));
                    }
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("accion", "getEventosDisponibles");
                return params;
            }
        };
    ...
    public void dialogAdvertenciaSalir(){
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(ListaEventosDisponibles.this);
